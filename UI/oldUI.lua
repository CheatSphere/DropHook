if getgenv().Library then
    return game.StarterGui:SetCore("SendNotification", {Title = "ERLChook",Text = "The script is already loaded!",Duration = 5,})
end
...
local Library do 
    ...
    Library = {
        ...
        Folders = {
            Directory = "ERLChook",
            Configs = "ERLChook/Configs",
            Assets = "ERLChook/Assets",
        },
    ...
    local Themes = {
        ["Preset"] = {
            ...
            ["Border 2"] = Color3.fromRGB(85, 85, 85)
        }
    }
    ...
    local CustomFont = { } do
        ...
        Library.Font = CustomFont:New("InterSemiBold", "Regular", "Normal", {
            Id = "Inter",
            Url = "https://github.com/CheatSphere/ERLChook/raw/refs/heads/main/UI/InterSemibold.ttf"
        })
    end
	...
	Library.Notification = function(self, Name, Duration, Icon)
		local Items = { } do 
			...
			})  Items["Notification"]:AddToTheme({BackgroundColor3 = "Element"})
			...
			Items["UIStroke"] = Instances:Create("UIStroke", {
				...
				ApplyStrokeMode = Enum.ApplyStrokeMode.Border
			})  Items["UIStroke"]:AddToTheme({Color = "Border 2"})
			...
			if Icon then
				Items["Icon"] = Instances:Create("ImageLabel", {
					Parent = Items["Notification"].Instance,
					Name = "\0",
					ImageColor3 = FromRGB(197, 184, 161),
					BorderColor3 = FromRGB(0, 0, 0),
			...
			Items["Text"] = Instances:Create("TextLabel", {
				...
				Name = "\0",
				FontFace = Library.Font,
				TextColor3 = FromRGB(197, 184, 161),
				BorderColor3 = FromRGB(0, 0, 0),
				Text = Name,
				AnchorPoint = Vector2New(0, 0.5),

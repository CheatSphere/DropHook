...
local groupboxes = {
    ...
    DropdownGroupBox = Tabs.Main:AddRightGroupbox("Dropdowns", "boxes")
}


groupboxes.LeftGroupBox:AddToggle("MyToggle", {Text = "This is a toggle",Default = true,Callback = function(Value)
...
groupboxes.LeftGroupBox:AddButton("button", function() 
    print("ok")
end)

groupboxes.LeftGroupBox:AddLabel("This is a label")

groupboxes.LeftGroupBox:AddLabel("This is a label\n\nwhich wraps its text!", true)

groupboxes.LeftGroupBox:AddSlider("FOVsize", {Text = "FOV Size",Default = 125,Min = 1,Max = 250,Rounding = 0,Callback = function(Value)
    print("[cb] MySlider was changed! New value:", Value)
end})

groupboxes.LeftGroupBox:AddInput("MyTextbox", {Default = "My textbox!",Numeric = false,Finished = false,
	Text = "This is a textbox",
	Callback = function(Value)
		print("[cb] Text updated. New text:", Value)
end})

groupboxes.DropdownGroupBox:AddDropdown("dropdown", {Values = { "1", "2" },Default = "1",Text = "dropdown",Searchable = true,Callback = function(Value) --// multi true
